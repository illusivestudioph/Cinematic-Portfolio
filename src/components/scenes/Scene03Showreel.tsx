...
export const Scene03Showreel: React.FC = () => {
  const { progress, content, setIsReelPlaying } = usePortfolio();
  const scene = PINNED_SCENES.showreel;

  // Scene 03 range: 550/1950 (0.282) to 750/1950 (0.385)
  const globalStart = 550 / 1950;
  const globalEnd = 750 / 1950;
  ...
  // Opacity: smoothly enters as clip expands, holds completely rock-solid, hands off to pull-out
  ...
  return (
    ...
    >
      {/* Viewport dominant showreel experience (85-100% viewport) */}
      <div className="w-[94vw] max-w-6xl h-[72vh] sm:h-[80vh] flex flex-col justify-center pointer-events-auto shadow-[0_0_120px_rgba(0,0,0,0.95)]">
        <CinematicVideoPlayer
          ...
          className="w-full h-full border-cyan-500/40 shadow-[0_0_80px_rgba(56,189,248,0.25)]"
        />
      </div>
